...
OQS_API OQS_STATUS OQS_KEM_kyber_512_encrypt(uint8_t* ciphertext, uint8_t* message, const uint8_t* public_key);
OQS_API OQS_STATUS OQS_KEM_kyber_512_decrypt(uint8_t* message, const uint8_t* ciphertext, const uint8_t* secret_key);
#endif
...
OQS_API OQS_STATUS OQS_KEM_kyber_1024_encrypt(uint8_t* ciphertext, uint8_t* message, const uint8_t* public_key);
OQS_API OQS_STATUS OQS_KEM_kyber_1024_decrypt(uint8_t* message, const uint8_t* ciphertext, const uint8_t* secret_key);
